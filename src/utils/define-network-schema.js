...
// const $parentArray = Object.getOwnPropertySymbols(
//   NetworkedMediaFrame.scale,
// ).find((s) => s.description == 'parentArray');
// const $storeFlattened = Object.getOwnPropertySymbols(NetworkedMediaFrame).find(
//   (s) => s.description == 'storeFlattened',
// );
...
//             data.push(
//               prop[$isStringType] ? APP.getString(prop[eid]) : prop[eid],
//             );
//           }
