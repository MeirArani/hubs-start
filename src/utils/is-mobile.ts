...
function isTablet(mockUserAgent?: string) {
...
//   MOBILE_RE.test(window.navigator.userAgent || window.navigator.vendor || window.opera) ||
//   TABLET_RE.test((window.navigator.userAgent || window.navigator.vendor || window.opera).substr(0, 4)) ||
//   isIOS() ||
//   isTablet() ||
//   isR7() ||
...
export function isMobile() {
  ...
  if (MOBILE_RE.test(userAgent) || TABLET_RE.test(userAgent.substring(0, 5))) {
    return true
  }
