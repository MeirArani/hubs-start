...
type ContentTuple = [number, number, number, number];
...
const objectTypeMimePrefixLookupMap = {
  'image/': [
    ObjectTypes.URL_IMAGE,
    ObjectTypes.FILE_IMAGE,
    ObjectTypes.CLIPBOARD_IMAGE,
    ObjectTypes.SPAWNER_IMAGE,
  ],
  'model/': [
  ...
  'audio/': [
    ObjectTypes.URL_AUDIO,
    ObjectTypes.FILE_AUDIO,
    ObjectTypes.CLIPBOARD_AUDIO,
    ObjectTypes.SPAWNER_AUDIO,
  ],
  'application/pdf': [
    ObjectTypes.URL_PDF,
    ObjectTypes.FILE_PDF,
    ObjectTypes.CLIPBOARD_PDF,
    ObjectTypes.SPAWNER_PDF,
  ],
} as { [key: string]: ContentTuple };
...
export function objectTypeForOriginAndContentType(
  contentOrigin: number,
  contentType: string,
  src: string,
) {
