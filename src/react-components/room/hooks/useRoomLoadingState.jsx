...
const messages = defineMessages({
  ...
  loadingObjects: {
    ...
    description:
      'The loading progress. How many objects have finished loading?',
    defaultMessage: 'Loading objects {loadedCount}/{objectCount}',
  },
  connectingScene: {
    id: 'loading-screen.connecting',
    description:
      'The scene is loaded, we are waiting for the networked scene to be connected to enter.',
...
export function useRoomLoadingState(sceneEl) {
  ...
  const doneLoadingObjects =
    lazyLoadMedia || shouldUseNewLoader() || allObjectsLoaded
  const done =
    sceneEl.is('loaded') ||
    (environmentLoaded &&
      networkConnected &&
