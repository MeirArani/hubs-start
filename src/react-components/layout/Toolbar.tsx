...
export function Toolbar({
  ...
  return (
    <div
      className={`relative h-24 flex justify-between p-3 bg-background1 border-t border-t-border-primary lg:py-3 lg:px-6 bg-white lg:justify-between ${className}`}
      {...rest}
    >
      <div
